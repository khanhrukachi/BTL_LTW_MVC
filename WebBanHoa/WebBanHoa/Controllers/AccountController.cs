    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                WebBanHoa.Common.Common.SendMail("ShopOnline", "Quên mật khẩu", "Vui lòng đặt lại mật khẩu của bạn bằng cách nhấp vào <a href=\"" + callbackUrl + "\">liên kết này</a> để reset mật khẩu", model.Email);
